...
const actionLabels: Record<string, string> = {
  ...
  leave_create: "登記請假",
  order_cancel: "取消訂餐",
  orders_generate: "補產今日訂餐",
  meal_order_dates_update: "調整指定日期訂餐",
...
const actionGroups = [
  ...
  { id: "meal", label: "訂餐餐費", description: "訂餐、領餐、結算", actions: ["orders_generate", "meal_order_dates_update", "order_cancel", "order_mark_received", "orders_settle", "order_charge_retry"] },
